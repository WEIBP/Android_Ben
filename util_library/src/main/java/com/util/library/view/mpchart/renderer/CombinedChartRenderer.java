...
import com.util.library.view.mpchart.charts.Chart;
import com.util.library.view.mpchart.charts.CombinedChart;
import com.util.library.view.mpchart.charts.CombinedChart.DrawOrder;
import com.util.library.view.mpchart.data.ChartData;
import com.util.library.view.mpchart.data.CombinedData;
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (DataRenderer renderer : mRenderers) {
            ...
            if (renderer instanceof BarChartRenderer)
                ...
                data = ((LineChartRenderer)renderer).getLineDataProvider().getLineData();
