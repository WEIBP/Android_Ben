package com.util.library.view.verticaltablayout;
...
import com.util.library.view.verticaltablayout.adapter.TabAdapter;
import com.util.library.view.verticaltablayout.util.DisplayUtil;
import com.util.library.view.verticaltablayout.widget.QTabView;
import com.util.library.view.verticaltablayout.widget.TabView;
...
public class VerticalTabLayout extends ScrollView {
    ...
    public VerticalTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mColorIndicator = typedArray.getColor(R.styleable.VerticalTabLayout_indicator_color,
                context.getResources().getColor(R.color.color_indicator));
