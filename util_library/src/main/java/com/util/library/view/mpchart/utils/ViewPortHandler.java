...
public class ViewPortHandler {
     ...
     */
    private float mMinScaleY =  0.01f;
     ...
     */
    private float mMinScaleX = 0.01f;
...
//        mMinScaleY = 1f;
    ...
    public void limitTransAndScale(Matrix matrix, RectF content) {
        ...
        // min scale-x is 1f
        mScaleX = Math.min(Math.max(mMinScaleX+0.001f, curScaleX), mMaxScaleX);

        // min scale-y is 1f
        mScaleY = Math.min(Math.max(mMinScaleY+0.001f, curScaleY), mMaxScaleY);
        ...
        matrixBuffer[Matrix.MTRANS_X] = curTransX;
        matrixBuffer[Matrix.MSCALE_X] = mScaleX;

        matrixBuffer[Matrix.MTRANS_Y] = curTransY;
