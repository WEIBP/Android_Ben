...
import com.util.library.view.mpchart.formatter.DefaultFillFormatter;
import com.util.library.view.mpchart.formatter.IFillFormatter;
import com.util.library.view.mpchart.interfaces.datasets.ILineDataSet;
import com.util.library.view.mpchart.utils.ColorTemplate;
...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
    ...
    private boolean isDrawLineEnable = true;



    private List<Integer> ignoredEntryIndex = new ArrayList<>();
    ...
    public void clearIgnoredEntries(){
        ignoredEntryIndex.clear();
    }

    public void addIgnoredEntry(int xIndex) {
        ignoredEntryIndex.add(xIndex);
    }

    public List<Integer> getIgnoredEntryIndex() {
        return ignoredEntryIndex;
    }

    public void setIgnoredEntryIndex(List<Integer> ignoredEntryIndex) {
        this.ignoredEntryIndex = ignoredEntryIndex;
    }
    ...
    public boolean isDrawLineEnable() {
        return isDrawLineEnable;
    }

    public void setDrawLineEnable(boolean drawLineEnable) {
        isDrawLineEnable = drawLineEnable;
    }
    ...
    public float getCircleRadiusDp(){
        return Utils.convertPixelsToDp(mCircleRadius);
    }
