...
package com.util.library.view.tableview.listener;
...
public class TableViewLayoutChangeListener implements View.OnLayoutChangeListener {
    ...
    private CellRecyclerView mStaticCellRecyclerView;
    @NonNull
    private CellRecyclerView mColumnHeaderRecyclerView;
    @NonNull
    private CellLayoutManager mCellLayoutManager;
    private CellLayoutManager mStaticCellLayoutManager;

    public TableViewLayoutChangeListener(@NonNull ITableView tableView) {
        this.mCellRecyclerView = tableView.getCellRecyclerView();
        this.mStaticCellRecyclerView = tableView.getmStatisticsRecyclerView();
        ...
        this.mStaticCellLayoutManager = tableView.getStaticticLayoutManager();
    }
    ...
    public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int
        ...
        if (v.isShown() && (right - left) != (oldRight - oldLeft)) {
            ...
            if (mColumnHeaderRecyclerView.getWidth() > mCellRecyclerView.getWidth()) {
                ...
                mStaticCellLayoutManager.remeasureAllChild();
