...
package com.util.library.view.tableview.listener.scroll;
...
public class HorizontalRecyclerViewListener extends RecyclerView.OnScrollListener implements
    ...
    private RecyclerView.LayoutManager mCellStatisticsLayoutManager;
    ...
    public HorizontalRecyclerViewListener(@NonNull ITableView tableView) {
        ...
        this.mCellStatisticsLayoutManager = tableView.getmStatisticsRecyclerView().getLayoutManager();
    ...
    public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
        ...
        if (recyclerView == mColumnHeaderRecyclerView) {
            ...
            for (int i = 0; i < mCellStatisticsLayoutManager.getChildCount(); i++) {
                CellRecyclerView child = (CellRecyclerView) mCellStatisticsLayoutManager.getChildAt(i);
                if (child != recyclerView) {
                    // Scroll horizontally
                    child.scrollBy(dx, 0);
                }
