...
import com.util.library.view.mpchart.charts.ScatterChart;
import com.util.library.view.mpchart.interfaces.datasets.IScatterDataSet;
import com.util.library.view.mpchart.renderer.scatter.ChevronDownShapeRenderer;
import com.util.library.view.mpchart.renderer.scatter.ChevronUpShapeRenderer;
import com.util.library.view.mpchart.renderer.scatter.CircleShapeRenderer;
import com.util.library.view.mpchart.renderer.scatter.CrossShapeRenderer;
import com.util.library.view.mpchart.renderer.scatter.IShapeRenderer;
import com.util.library.view.mpchart.renderer.scatter.SquareShapeRenderer;
import com.util.library.view.mpchart.renderer.scatter.TriangleShapeRenderer;
import com.util.library.view.mpchart.renderer.scatter.XShapeRenderer;
