...
public class LogFunction implements Function {
	...
	/**
	 * If the number of parameters specified is 1, then the log base 10 is taken
	 * of the value at index location 0. If the number of parameters specified
	 * is 2, then the base value is at index location 1.
	 */
