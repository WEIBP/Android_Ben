 ...
 * values at index locations 0 and 1. See the FuncMap class for more
 * information.
 * 
 * @see com.math.stringparser.FuncMap
 */
public interface Function {

	/**
	 * Takes the specified double array as input and returns a double value.
	 * Functions that accept a variable number of inputs can take numParam to be
	 * the number of inputs.
	 */
	public double of(double[] param, int numParam);

	/**
	 * Returns true if the numParam is an accurate representation of the number
	 * of inputs the function processes.
	 */
