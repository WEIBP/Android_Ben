...
public class ClientManager {
                ...
                public void run() {
                        try {
                                while (!isExit) {
                                        ...
                                        L.object("获取的手机IP地址及端口号：" + socket.getRemoteSocketAddress().toString());
                                        /**
        ...
        public static ServerThread startServer(int port) {
                ...
                if (serverThread != null) {
                        L.object("server不为null正在重启server");
                        // 以下为关闭server和socket
                        shutDown();
                }
                // 初始化
